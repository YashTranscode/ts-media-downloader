<h3 align="center">
  ...
  <p align="center"><img src="https://img.shields.io/badge/WLCM%20TO -TC MEDIA DOWNLOADER-green?colorA=%23ff0000&colorB=%23017e40&style=flat-square">  
  
</h3>

[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Neuton&size=25&color=30FF40&background=000000&center=true&vCenter=true&width=360&height=60&lines=Hello+World%2C+I'm+Mr-TC+Here+🤙;𝙸𝚃'𝚜+𝙽𝙾𝚃+𝙰+𝙹𝚄𝚂𝚃+𝙽𝙰𝙼𝙴+𝙱𝚁𝙾+🥱;𝙸𝚃'𝚜+𝙰+𝙱𝚁𝙰𝙽𝙳+🔥;Respect+Mr.TC+🥀;Thanks+My+All+Friend+🤙+🥰)](https://git.io/typing-svg)


<a href="https://www.npmjs.com/package/tc-media-downloader"><img alt="npm version" src="https://img.shields.io/npm/v/tc-media-downloader.svg?style=flat-square"></a>
<img alt="version" src="https://img.shields.io/github/package-json/v/TC/tc-media-downloader?label=github&style=flat-square">
<a href="https://www.npmjs.com/package/tc-media-downloader"><img src="https://img.shields.io/npm/dm/tc-media-downloader.svg?style=flat-square" alt="npm downloads"></a>
[![js dilvr](https://data.jsdelivr.com/v1/package/npm/tc-media-downloader/badge)](https://www.jsdelivr.com/package/npm/tc-media-downloader)

## Instalation :
```bash
> npm i tc-media-downloader
```
## Last Update 
```print
• Instragram (new add)
...
## Example (fb & insta)
```js
const { ndown } = require("tc-media-downloader")
...
## Instagram Usage 
```js
const {instagram} = require("tc-media-downloader");
...
## Example (TikTok)
```js
const { tikdown } = require("tc-media-downloader")
...
## Example (YouTube)
```js
const { ytdown } = require("tc-media-downloader")
...
## Example (Twitter)
```js
const { twitterdown } = require("tc-media-downloader")
...
## Example Fbdown 
```js
const { fbdown } = require("tc-media-downloader");
...
## Example Fbdown2
```js
const { fbdown2 } = require("tc-media-downloader");
const request = require('request')
...
## Usage GDLink 
```js
const {GDLink} = require("tc-media-downloader");
...
## Usage Pintarest 
```js
const {pintarest} = require("tc-media-downloader");
...
## Usage CapCut 
```js
const { capcut } = require("tc-media-downloader");
...
## Usage Likee 
```js
const { likee} = require("tc-media-downloader");
...
[![Github](https://img.shields.io/badge/Github-MrDarkYTgreen?style=for-the-badge&logo=github)](https://github.com/MOHAMMAD-TC)
